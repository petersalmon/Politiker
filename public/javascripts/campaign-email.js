...
$(document).ready(function(){
    ...
    var scriptTitles = $(".script-vals-hidden[data-type='email']").map(function(){return $(this).attr("data-title");}).get();
...
$(document).on('click','#emailTable tr',function(e){
...
function getStatCounts(){
    var numTrs = $("#emailTable").children('tbody').children('tr').length;

    var contactedArray = $('#emailTable td:nth-child(5) select').map(function(){
        return $(this).val();
    }).get()
    var contactedCounts = {};
    ...
    var respondedArray = $('#emailTable td:nth-child(6) select').map(function(){
        return $(this).val();
    }).get()
    var respondedCounts = {};
    ...
    var supportArray = $('#emailTable td:nth-child(7) select').map(function(){
        return $(this).val();
    }).get()
    var supportCounts = {};
...
// highlight table row
$('#emailTable').bind('click', function(e) {
    if($('#edit-mode-switch').is(':checked')) {
...
$("#save-camp-btn").click(function(){
    ...
    $("#emailTable").find('tr').each(function(i) {
    ...
    customColDict= {};
    $("#emailTable th.custom-col").each(function(){
        var colDict = {}
...
$(document).on('change','#emailTable select',function(){
    var counts = getStatCounts();
