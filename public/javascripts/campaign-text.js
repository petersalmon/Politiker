...
$(document).ready(function(){
    ...
    var scriptTitles = $(".script-vals-hidden[data-type='text']").map(function(){return $(this).attr("data-title");}).get();
...
$(document).on('click','#textTable tr',function(e){
...
function getStatCounts(){
    var numTrs = $("#textTable").children('tbody').children('tr').length;

    var contactedArray = $('#textTable td:nth-child(5) select').map(function(){
        return $(this).val();
    }).get()
    var contactedCounts = {};
    ...
    var respondedArray = $('#textTable td:nth-child(6) select').map(function(){
        return $(this).val();
    }).get()
    var respondedCounts = {};
    ...
    return [numTrs, numContacted, numResponded];
}

// highlight table row
$('#textTable').bind('click', function(e) {
    if($('#edit-mode-switch').is(':checked')) {
...
$("#save-camp-btn").click(function(){
    ...
    $("#textTable").find('tr').each(function(i) {
    ...
    customColDict= {};
    $("#textTable th.custom-col").each(function(){
        var colDict = {}
...
$(document).on('change','#textTable select',function(){
    var counts = getStatCounts();
